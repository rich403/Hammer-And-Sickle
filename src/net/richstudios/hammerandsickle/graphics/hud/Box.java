	...
	protected void draw(Graphics2D g, int ox, int oy) {
		for (int x = 0; x < aWidth; x++) {
			for (int y = 0; y < aHeight; y++) {
				...
				else if(x == 0 && y == aHeight - 1) g.drawImage(sprites[2][0], dx, dy, SIZE * size, SIZE * size, null);
				else if(x == aWidth - 1 && y == 0) g.drawImage(sprites[0][2], dx, dy, SIZE * size, SIZE * size, null);
				...
				else if(x == aWidth - 1 && y == aHeight - 1) g.drawImage(sprites[2][2], dx, dy, SIZE * size, SIZE * size, null);
				else if(x == aWidth - 1) g.drawImage(sprites[1][2], dx, dy, SIZE * size, SIZE * size, null);
				else if(y == aHeight - 1) g.drawImage(sprites[2][1], dx, dy, SIZE * size, SIZE * size, null);
